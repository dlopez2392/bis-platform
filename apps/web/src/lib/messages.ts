export const m = {
  ...
  "settings.alertPhoneSaved": "Alert phone updated",
  ...
  // only the agency's own Checklist can act on it.
  "settings.alertPhoneNotReady": "Texting isn't turned on for this account yet, so no alert texts will go out until it is. See Checklist.",
