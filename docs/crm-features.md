...
1. **BIS today is a working, contact-centred CRM with a bilingual AI receptionist that has answered real client calls.** It has contacts, one pipeline, forms, one booking calendar, email, an inbox, automations and weekly reports, behind server-enforced quality gates. It does not yet have what the owner asked for (documents on the record and calendar sync), nor what the constraints and the study require (staff roles, a Spanish dashboard and a phone layout). No company can text, because none has cleared carrier registration, and nothing is charged, because no deployment holds a Stripe key. *See §2.*
2. **The critical path is the consent chain, not a feature.** The consent ledger and one send gate that every message must pass go live by **1 December 2026**, a planning date chosen because that is when texting should switch on, and no account texts before it, whatever the carrier says. The revocation rule in force since April 2025 applies from the first text. The FCC's draft rewrite, released on 9 September 2026 for a vote at its 30 September open meeting, would change a revocation's scope and let a sender name an exclusive opt-out method; it would take effect 30 days after publication, possibly in November or December 2026. Under today's rules, 31 January 2027 is the latest the chain could go live, and it is not the target. *See §4.2.*
3. **Fix what exists before adding screens.** The inventories and this plan's reviews found 105 distinct defects (13.9–23.3 ew), a hardening sprint of 56 known items (8–11 ew), and no alerting, error tracking or tested restore. With the legal chain, an operational floor and the first Spanish comparison, this is 31.4–45.8 ew, and none of it is optional. *See §2.3 and §4.2.*
4. **Build the study's first release, re-costed at 53.5–73 ew, not 27–36.** Staff and roles, the client record, the record page, the consent ledger, bilingual messages, the document vault, inbound email and one review tray for AI suggestions. This is the direct answer to "centralise each customer with all their documents" and the first answer to "use AI with the CRM". Inbound email captures replies to mail BIS sends and anything the business forwards to a record's own address; mail a customer writes straight to the business owner's own Gmail or Outlook does not reach the record until inbox sync, which waits for demand (§7.1). Staff logins stay within Clerk's five memberships per company, the agency's included, until the cap is raised for the first company that needs a fifth login, as the M2 spec allows (§4.3). The AI the business owner gets, and when (proposal): in the first release, a bilingual summary on every record, and suggestions from calls that each wait in one tray with their evidence (suggestions read from email and texts use the same tray, but only once decision 6's terms are in place, because they are a new path for health details to reach the model); in H1 2027, a photo or PDF read into proposed fields (S-19); in H2 2027–2028, replies drafted and translated in the customer's language (S-16, F-025) and Ask BIS answering questions about the business (S-18, F-095). *See §4.3, and §4.8's AI row for the schedule.*
5. **Sell Sofía first, in parallel.** Guardrail modules, price-list grounding and tenant vetting let BIS sell the receptionist to insurance agencies and event venues at once, and to law firms once the Opinion 680/705 sheet exists. Six small riders, capped at 13.5 ew, make Sofía and the CRM-only plan sellable this winter: a card for every call, texting without Sofía, Spanish at every edge of a call, "manage my appointment", a usable phone width and visible lead sources. *See §4.3.*
6. **Google and Microsoft: Outlook first, then Google, then everything else.** Outlook leads because Microsoft's publisher verification is free and takes days, while Google's calendar scopes need a review. Sign-in and verification come now. At the head of next (April 2027), a private calendar feed puts every BIS booking on the business owner's own calendar, Apple's included, with no review at all (proposal, F-048 part 2); Google and Outlook refresh such feeds only every few hours, so it is a near-live view on Apple devices and a delayed one elsewhere. Also in next, the business owner's own calendar becomes two-way: on Outlook where the client runs Microsoft 365, and on Google after a review of the calendar scopes alone, submitted in H1 2027 (a Testing-mode pilot until it passes). Per-staff calendars, send-as-me, file pickers and contacts sync follow in H2 2027–2028, send-as-me and contacts sync through a second Google review. Full inbox sync comes only if customers ask. *See §7.*
7. **Keep the AI honest.** Every new AI write lands in one review tray, with its evidence and an undo. Today Sofía and the web chat already write some records live; until the owner rules, Sofía's filling of blank fields becomes a proposal, and whether an act the caller asks for and confirms counts as an "AI write" is the owner's decision 19, for which the plan recommends the narrow reading. *See §3 and §9.*
8. **Do not build what nobody asked for.** Eighteen features are dropped, among them outbound AI callbacks, payment by consumer agents and a generic lens framework; the design pass also rejects a native app now, a notification bell and a monday-style layout editor. The rule builder stays deferred; four fixed trigger primitives replace it. *See §4.7 and §6.7.*
9. **The biggest bets:** the Spanish dashboard and the phone shell in H1 2027; industry packs in order, home services first; a Spanish receptionist whose quality is published and measured (F-194, F-130); and being found and booked by AI assistants (F-157 now, the rest as the traffic appears). A published promise of a local bilingual person behind the product (F-195) is a smaller bet, in the tail of later that slides first. *See §5.*
10. **The capacity holds, just.** At 5–6 conventional ew a week, now holds 111.9–153.8 ew against 130–156, and the plan through 2028 is 525.4–719.8 ew against 585–702. This rests on the pace the repository has shown since July (about 5.5–8 conventional ew a week, costed by us), re-measured monthly; at three to four a week the owner re-scopes the plan rather than re-ordering it. At the study's conventional reading (one engineer, about 52 ew a year), the plan's 686.9–942.3 ew would be about 13 to 18 years of work. There is a written cut order, and the legal chain, the hardening sprint and the first release's eight study items are never cut. *See §4.1 and §4.8.*
11. **Validate before building on a guess.** The RGV Wedding & Quince Expo on 27 September 2026 starts testing how event vendors take inquiries, holds, cash and payments from padrinos (H1 to H4); discovery calls in October and November finish those and test the rest. The value judge flagged 26 features FLAG-M, because each rests on a Valley pattern nobody has checked or revisits a recorded decision. None is built beyond its cheapest part until its answer is in: F-003's relationship labels and F-018's source question ship now because they cost almost nothing, and F-034's disclosure runs first as a measured one-account trial (H22). *See §10.*
12. **Who BIS serves, and when (proposal).** Plumbers and the other trades first, because the live HVAC client and study decision 8 put home services first and today's Sofía already serves them: Sofía's guardrails, the call card and the booking fixes now, the home-services Sofía module in H1 2027, and the home-services pack in H2 2027–2028. Restaurants meet BIS through Sofía at the front desk (F-199) in H2 2027–2028, because Sofía must first quote menus and hours as owner-edited facts (S-44, F-037 part 2), and only if restaurants confirm they want it (H10); discovery calls with restaurants start now. A catering pack follows in 2029–2030 after POS research. Child day care gets a Spanish front office beside the centre's own system in 2028, once three to five centres confirm it (H9), because brightwheel and Procare already hold the child's file. Insurance agencies and event venues buy Sofía now, and law firms once the 680/705 sheet exists. Adult day care and home health stay out, and the HIPAA verticals stay on hold behind study decision 5. *See §4.8's owner's-asks table and §5.14.*
13. **What BIS takes from HubSpot and monday, and what it refuses.** It takes HubSpot's three-column record and unified timeline; monday's recency cue (a last-contact column and a "no contact in 30 days" filter, in the first release) and saved views; a two-question check-in after the job in place of HubSpot's NPS surveys; an MCP server, as both HubSpot and monday offer; and importers from both. It refuses layout editors, record tabs, owner-built custom objects and per-seat pricing, because a five-person shop has no admin and BIS is priced per business: the entry plan's logins should cover a typical small crew, so adding a technician does not change the price until the shop outgrows its plan. Until the plans price logins (F-117's later part), the Clerk cap of five memberships per company is raised for any company that needs more (§4.3). *See §4.8 and §6.1.*
14. **Seventeen new owner decisions (19 to 35) join the study's eighteen.** Rule on study decisions 1, 2, 6, 14, 15 and 16–18, and on this plan's 19, 20, 21, 25, 27, 28, the first groups of 33 and 34 and the first sitting of 35, in October 2026, before the first release starts; on 23, 24 and 35's second sitting in January 2027, before next starts; and on the rest as their features start. *See §9.*
...
- **Sofía has answered real client calls.** On 2026-09-17 a woodworking business, live for one day, took nine calls; eight were the same scam robocall, and the robocall hang-up shipped in response. On 2026-09-18 an HVAC company had 40 contacts, 34 real calls and 16 deals.
...
- **Dormant or unconfirmed:** video meetings (no Daily.co key), the three marketing automations (never set up on a live company as of 2026-09-23), the website assistant (off by default; no recorded use by a real client), and website traffic (live on one real site, BIS's own, since 2026-09-08).
- **Nobody is alerted when production breaks.** There is no error tracker, alerting, health endpoint or log drain, and nothing documents or tests a backup or a restore.
...
| ⌘K palette: jump to pages and settings, live search of contacts, calls and conversations | **Partial** (three settings cards unregistered; §2.2.9) | `apps/web/src/lib/palette/registry.ts:36-145` |
...
| Outbound email through Resend, saved before sending so a failure shows in the thread | **Live** | `apps/web/src/lib/email/index.ts:20-44` |
...
| Quiet hours for automated sends (default 21:00 to 08:00, company zone) | **Live** | `apps/web/src/lib/automations/quiet-hours.ts:1-40` |
| Outbound texts (typed, automated, text-back) | **Built, dormant** (waits on A2P approval) | `apps/web/src/lib/sms/sender.ts:30-47` |
| Inbound texts into the thread | **Built, dormant** (waits on A2P and on carrier set-up that no runbook covers) | `apps/web/src/app/api/sms/inbound/route.ts:75-206` |
...
| A2P registration record on the agency checklist | **Partial** (IDs and status typed by hand; no carrier API, no status checks, no setup-wizard step) | `apps/web/src/app/(dashboard)/dashboard/accounts/[accountId]/checklist/a2p-panel.tsx:25-48` |
...
| Publish, unpublish and archive | **Live** | `packages/db/src/forms.ts:113-120` |
...
| Instant text reply to the submitter | **Built, dormant** (waits on A2P; an agency-only recipe, off by default once it clears) | `apps/web/src/lib/automations/instant-reply.ts:95-200` |
...
| Embed on the client's website | **Live** | `apps/web/src/app/(dashboard)/dashboard/accounts/[accountId]/calendar/embed-snippet.tsx:15-30` |
...
| Reminder email about 24 hours ahead | **Partial** (English only; no switch; skipped for bookings made under about 23 hours ahead) | `packages/db/src/booking.ts:601-612` |
...
| Sofía checks, books, finds, reschedules and cancels by phone | **Live** | `apps/web/src/lib/voice/tools/registry.ts:73-404` |
...
| Booking tools on the call | **Live** | `apps/web/src/lib/voice/tools/registry.ts:73-404` |
...
| Cost cap, silence guard, robocall hang-up, daily caps, repeat-spam block | **Live** | `apps/web/src/lib/voice/call-limits.ts:13-53` |
...
| Topbar presence and dashboard calls chart | **Live** | `apps/web/src/lib/voice/presence.ts:24-67` |
...
| "Talk to Sofía" web demo on the BIS website | **Behind a flag** (environment-gated, single company, no tools, leaves no record; production state not visible) | `apps/web/src/app/api/voice/web/session/route.ts:55-247` |
...
| One billable unit per answered chat | **Built, dormant** (recorded in the ledger; nothing reaches Stripe) | `apps/web/src/app/api/concierge/[publicId]/turn/route.ts:536-549` |
...
| Email reminder about 24 hours before a booking | **Partial** (always on; no switch; English only; skipped for bookings made under about 23 hours ahead) | `apps/web/src/lib/automations/passes/reminders.ts:35-40` |
...
| Instant text reply to a new web lead, in English or Spanish | **Built, dormant** (waits on A2P; an agency-only recipe, off by default once it clears) | `apps/web/src/lib/automations/instant-reply.ts:95-205` |
| Quiet hours per account; held sends go at the window's end | **Live** (agency edits; clients cannot see the window) | `apps/web/src/lib/automations/hold-or-send.ts:169-217` |
| Caps: 10 per pass per tick, 25 per recipe per account per day | **Live** (fixed platform constants) | `apps/web/src/lib/automations/caps.ts:19-33` |
...
| Per-contact "No marketing emails" switch | **Live** | `apps/web/src/app/(dashboard)/dashboard/accounts/[accountId]/contacts/marketing-optout-switch.tsx:12-23` |
| Usage report to Stripe meters | **Built, dormant** (no Stripe key and no billed account; since #146 a row Stripe already holds is marked reported, not retried) | `apps/web/src/lib/automations/passes/usage-report.ts:137-159` |
...
**Bilingual today:** only the dormant instant reply has Spanish bodies, so every automated message a customer can receive today is English; the page, its stored reasons and both report emails are English.
...
| Topbar presence: "Sofía · on a call" or "N calls handled this week" | **Live** | `apps/web/src/components/topbar-presence.tsx:21-56` |
...
| A2P registration record | **Live** (the record gates every text; no account is recorded approved) | `apps/web/src/app/(dashboard)/dashboard/accounts/[accountId]/checklist/a2p-panel.tsx:25-194` |
...
| Deploy on merge to `main` | **Live** | `apps/web/vercel.json` |
...
| Rate limits and bot guards on public forms, booking and chat | **Live** | `apps/web/src/lib/forms/guards.ts:9-19` |
...
| Error boundaries | **Partial** (dashboard, booking and form only; none on chat; no root "not found") | `apps/web/src/app/f/error.tsx` |
...
| M2 Booking: one calendar per company, page, embed, reminders | **Behind a flag** (per-company calendar switch, off by default; the agency or the client turns it on) | `packages/db/supabase/migrations/0016_booking.sql:11-14` |
...
| Cancel on the Calendar page is irreversible, with neither a typed confirmation nor an undo (rule 6) | `.../calendar/bookings-list.tsx:93-95` | F-048 (rider: Cancel's dialog becomes the rule-6 confirmation) |
...
| When an account's zone cannot be resolved, the dashboard's zone note tells the agency to "Set it in Settings" and links there, but Settings has no time zone field; the only zone input is in the Add company dialog (§2.2.1) | `apps/web/src/lib/messages.ts:1955`; `apps/web/src/components/zone-note.tsx:102`; `.../accounts/create-account-dialog.tsx:78` | ½–1 d |
...
| 4 | **A person approves every AI write.** Every new AI write goes through the review tray. Until decision 19 is dated, Sofía's filling of blank fields on an existing contact becomes a proposal of the existing `contact_field` kind; the acts a caller asks for and confirms (booking, rescheduling, cancelling, leaving their own name and number) continue live and gain author stamps and undo; and no new live write path is added. An AI write is a change to a record or a message sent to a customer; a labelled summary or description shown only to the business's own people (F-028's descriptions, F-100's paragraph) is not one. If the owner reads it otherwise, decision 19 settles it | Binding constraint 5 |
...
This section is order and effort; section 5 is what each feature is and why. Every placement is a proposal until the owner decides (§9). "Part" marks a split feature, shown once per horizon it touches. A "Depends on" cell names the owner decisions a feature waits for; the features listed in decision 33's second group and decision 34's later moves also wait on those decisions, whether or not their cells repeat it (§3.2 rule 11).
...
**The pace check (proposal).** The pace is our own backcast of greenfield work, not a measurement of rework, so it is re-measured on the first working day of every month: the conventional ew of the items that shipped to a real client, against the weeks elapsed. If two consecutive months come in at three to four ew a week, re-ordering alone does not rescue the plan, and the owner re-scopes it. At that pace now holds 78–104 ew. Keeping only the legal chain, the hardening sprint, the operational floor, the defects, the first release's eight items, M7a (S-62) and the first Spanish comparison (F-194) costs 88.4–123.8 ew, or 81.9–114.8 once the first release's last items (the vault's kit and inbound email, 6.5–9 ew) slide into next: still over at the high bounds. Next, 39–52 ew at that pace, would then absorb those items, the riders (10–13.5 ew) and the rest of the parallel work (13.5–16.5 ew, Sofía's insurance and events modules included) on top of its own 54.5–74: 84.5–113 ew, about twice its capacity. So the first step moves that work, and the second is the owner's: which of next's own items slide to later (F-046 part 1, F-077 part 1 and F-175 part 1 first, then F-092 part 1, F-095 part 1 and F-107 part 2), and how much of later then slides into 2029.
...
1. **The legal-date chain, and what it stands on:** the consent chain, the hardening sprint, an operational floor, and the defects the inventories found. It is not capped, because none of it is optional (31.4–45.8 ew).
...
4. **Riders, capped at 13.5 ew**, which is half the study's first-release low bound of 27 (10–13.5 ew). The cap exists so that riders never become a second first release, and half of the smallest first release still carries the six fixes that make Sofía and the CRM-only plan sellable this winter. Each rider must:
   ...
   Some riders therefore have named same-horizon prerequisites. The owner-facing riders (F-033's call card, F-141's texting settings and F-157's lead-source display) ship after F-013 part 1's runtime and ratchet gate, so that they ship in English and Spanish as §3.2 rule 13 requires; F-010 follows the Spanish-greeting defect; F-141 also follows the send gate (chain step 4). F-048 and F-107 use today's bilingual public string modules or add no owner copy, so they can ship first. The same sequencing binds the parallel work's owner-facing pieces: F-084's switch and its owner grant ship after F-013 part 1's runtime and gate, or with their English and Spanish strings written out; chain step 5's confirmation row, which must be live by 1 December, ships with its strings written out.
...
| Step | When | Why |
|---|---|---|
| Register A2P 10DLC for the two live client accounts and BIS's own line, by hand in the Telnyx portal | Start this week | No account is approved, so every text path is dormant: typed texts, reminders, the missed-call text-back, owner alerts and the alert-phone code. Each carrier round takes 3–7 business days, plus fees and evidence. **Texting stays switched off for every account until the send gate (chain step 4) is live**, whatever the carrier says |
| Check the live Telnyx messaging profile and register whichever of the study's six Spanish opt-out keywords are missing (PARAR, DETENER, ALTO, CANCELAR, BAJA and NO MAS), registering NO MÁS as well, since customers type with and without accents and carriers match keywords literally; start a staff routine for stop requests written in free text | This week (study §11.2) | Nobody has yet confirmed what is registered: Telnyx recognises only English stop words by default, and the code's comment says the Spanish ones work only once registered. No system honours a stop request written in a sentence |
...
| File the Business Profile API application | This quarter | It needs a verified profile active 60 days or more (BIS's own or a managed client's) and a website for that business, and approval has no published timeline (study §11.2) |
...
| Engage counsel for four readings | October 2026 | The message-class table, the keyword list and the stop confirmation's wording (47 CFR 64.1200(a)(12)) against the FCC order as adopted, re-checked after the 30 September vote, with SB 140's reach over consent-based texting (the Secretary of State's registration FAQ and the pending Attorney General request, RQ-0626-KP); the disclosure wording (decision 20); the Opinion 680/705 sheet; the insurance intake against Texas Insurance Code §4001.051(b) |
| Write a runbook step for honouring a customer's deletion request by hand, and ask counsel which clients the TDPSA reaches | This quarter | Bulk delete skips any contact with a booking, deal or conversation, and F-122 is 2029–2030 (§5.11) |
...
| The owner's decisions needed before the first release starts | October 2026 | Study decisions 1, 2, 6, 14, 15 and 16–18; this plan's 19, 20, 21, 25, 27 and 28, the first groups of 33 and 34, and 35's first sitting |
...
- **That date may no longer hold.** On 9 September 2026 the FCC released a draft Report and Order and Further Notice rewriting the rule, circulated for a vote at the Commission's 30 September 2026 open meeting; it has not been adopted ([Troutman Pepper Locke, 17 September 2026](https://www.troutman.com/insights/fcc-revises-tcpa-revocation-of-consent-rules-that-were-set-to-go-into-effect-in-january/); [Covington, 11 September 2026](https://www.insideglobaltech.com/2026/09/11/fcc-releases-draft-rules-and-proposals-on-tcpa-consent-revocation/); [Hall Render, 22 September 2026](https://hallrender.com/2026/09/22/tcpa-update-fcc-seeks-to-overhaul-consent-revocation-rules/)). One post headlines it as adopted ([Hunton](https://www.hunton.com/privacy-and-cybersecurity-law-blog/fcc-adopts-clarifying-changes-to-tcpa-revoke-all-rule-effective-30-days-after-publication)); the draft itself ([FCC-CIRC 2609-05 and its fact sheet](https://docs.fcc.gov/public/attachments/DOC-424844A1.pdf)) says it is circulated for tentative consideration at the 30 September open meeting, which contradicts that. As drafted, the order:
  ...
  - rewrites (a)(11) and (a)(12): the new (a)(12), on the confirmation text, drops today's clause that lets a confirmation ask which categories to stop;
...
- **The plan puts the chain live by 1 December 2026** because that is when texting should switch on: the live accounts' A2P registrations should clear by then, and the CRM-only plan needs texting to sell. It is a planning date, not one the law forces, and 31 January 2027 is an outer limit, not a target.
...
|---|---|---|---|---|
| 0 | — | Spanish opt-out keywords on the Telnyx profile; the interim staff routine for stop requests written in free text | configuration | Operational steps |
...
Nobody at BIS is told today when production breaks. There is no error tracker, alerting or log drain, and nothing in the repository documents or tests a backup or a restore. The floor adds no new vendor.
...
Most fixes take hours, not weeks. The estimate allows half a day to a day for each, with tests (0.1–0.2 ew), plus the slices and the skeletons named.
...
| | F-096 (part) | Mi cuenta: language and theme (F-111 folded in; its larger text and more contrast wait for amendment 19, ruled when F-096's later part starts) | | +0.5–1 |
...
| | F-022 | author columns, AI writes stamped as AI, visible and undoable acts, phone-cancel notices | | +2.5–3 |
...
**Decisions it needs.** Study decisions 1 and 2, as the study says. From this plan: 19, which reads the approval rule for item 8; 33's first group, for member sync and owner settings in item 1, the reminder timing in item 5 and editing before accept in item 8; and 35's first sitting, for DESIGN.md's new sections, the module contract, "at most one hero", bilingual in the definition of done and the operator's default theme.
...
| | *AI subtotal* | *2.5–4* | | |
| **Calendar** | | | | |
| F-048 (part: the owner's calendar feed) | Manage my appointment: move in place, cancel with a way back, add to calendar | 1 | Proposal. A private, revocable link per person, in both languages, that Apple, Google and Outlook calendars subscribe to: every BIS booking on the owner's own phone, with the time, the service and the customer's first name only. It needs no Google review and no Microsoft admin, and it is the only route for an owner whose calendar is the iPhone's own. One-way: the owner's own events do not block Sofía's slots until S-22. It is near-live only on Apple devices, where the refresh interval is set on the phone; Google and Outlook refresh subscribed feeds every few hours (Microsoft says it can take more than 24), and a Google user adds the feed once from a computer, not the phone app. So the booking alert email, and the text once A2P clears, stays the prompt channel, and S-22 is the real-time answer | F-048 (part 1), S-01 |
| S-22 | Owner's calendar on Outlook and Google, with Meet, Teams and attendee matching | 6–8 | The owner's own ask; Outlook first; Google's calendar scopes submitted for review alone, a Testing-mode pilot until it passes | S-27, S-28, F-196, decision 34 (the Google review) |
...
| **Messaging** | | | | |
| F-070 (part: phase 0, a `wa.me` link whose clicks measure demand, and the one-week spike) | WhatsApp through Telnyx, inbound first | 0.5–1 | Costs about a day and produces the data decision 11 lacks | decision 23 |
| | *Messaging subtotal* | *0.5–1* | | |
| **Owner's day** | | | | |
| F-077 (part: inline accept and Done on today's loose ends: callbacks, failed transfers, phone cancellations) | The work queue finishes what it shows: one-tap actions and every loose end | 3 | Consumes F-019's kind registry and inverses | F-019, F-033 |
...
| F-088 | Show what the business uses: five surface states and one upgrade page | 2–3 | Honest plan states, paired with entitlements so the screen never lies | S-13, F-087 |
...
| F-095 (part: palette v2 with Spanish keywords and 'go') | One box: find, go, or ask, in either language | 1.5 | Ships with the Spanish dashboard | S-10, F-092 (part 1) |
...
| | *Growth subtotal* | *7–9* | | |
| **Packs** | | | | |
| F-174 (part: the law module, after the 680/705 sheet, and home services) | Sofía industry modules | 2 | Decision 15: sell Sofía to law firms once the sheet exists | F-124 (part 1) |
...
| F-039 | Sofía sets herself up from the business's own website | 2 | Agency-run, fills today's profile and hours; speeds hand-run onboarding | F-037 (part 2), F-173 |
...
| F-051 | Holds: a first-class booking state that a person confirms | 3–4 | The `held` status on today's single calendar, before the events pack that uses it | decision 22 (rooms only) |
...
| **Money** | | | | |
| S-08 | In-house e-signature | 3–5 | Law, insurance, events and child care need it; it signs documents from the vault and waits on decision 2 | S-07, decision 2 |
...
| **Trust** | | | | |
| S-39 | Regulated-tenant mode | 1–2 | Holds regulated tenants; F-173's vetting covers the binding constraint until then | F-173, decision 5 |
...
| F-117 (part: MFA and sessions the owner controls; Clerk's Spanish sign-in emails and widgets; the Clerk member cap priced) | Sign-in security the owner controls | 3–4 | Needed before the tax offer (decision 18). Clerk's component localization is experimental and does not reach its emails or its hosted Account Portal ([Clerk](https://clerk.com/docs/guides/customizing-clerk/localization)), so bilingual invitations and codes need one bilingual template or emails sent by BIS; confirm before costing | S-01 |
...
| S-35 | Spreadsheet import with header mapping, `.xlsx` export | 1–2 | CSV import already works; header mapping speeds hand-run onboarding | none |
| S-36 | Importers from HubSpot and monday | 2–3 | When a switching prospect needs one | S-02 |
...
| F-195 | Una persona de BIS: a published local service promise | 2–3 | Publish only what was measured | F-097, F-136 |
...
| S-55 | Law pack | 2–3 | Receptionist sold now; the pack after the vault, e-signature and roles-enforced restriction | S-07, S-08, S-48, F-004 |
...
| F-172 | Starter packs now, plus the five blueprint fixes | 2–3 | Blueprint defects are fixed now; starter packs head the pack work | F-173 (part 1) |
...
| F-185 | Child-care front office pack | 6–8 | Fourth pack | S-42, F-004, hypothesis H9 |
...
| F-199 | Restaurants start with Sofía at the front desk; the catering pack comes later | 2–3 | The owner named restaurants; the catering pack waits on POS research | S-44, F-174, F-037 (part 2), hypothesis H10 |
...
| F-026 | Job debrief by voice | 2–3 | A record button on the booking, piloted with the HVAC client, with the notetaker | S-20, F-019 |
...
| **Growth** | | | | |
| F-137 | Setup partners: scoped seats for certified local helpers | 6–8 | Designed once with agency scoping | F-118, F-138 |
...
| F-149 | Open platform: API keys, signed webhooks, Zapier, Make and n8n | 3–4 | Valley leads arrive through Meta, not Zapier | F-115 |
...
| F-155 (part: a trusted referral list in F-037) | Recomendados: a referral network between Valley businesses | 0.5–1 | Rests on H6 | F-037 (part 2) |
| F-155 (part: handing leads between accounts) | Recomendados: a referral network between Valley businesses | not costed | Needs density and a privacy review | hypothesis H6 |
...
| F-160 | The business page assistants read | 3–4 | After F-037's second part; how it sits beside the websites BIS builds is decision 25's | F-037 (part 2), decision 25 |
...
| | **Horizon total (55 rows)** | **161.5–222.5** | | |
...
| F-111 | Display settings that follow the person | S (2) | F-096 | display settings in Mi cuenta's one store |
...
**Through 2028** (now, next and later), the plan is **525.4–719.8 ew**. The capacity for those 117 weeks is 585–702. The low bound fits. The high bound runs about 18 ew over, which later's named tail (18.5–26 ew) covers.
...
| Restaurant owners | Discovery calls (H10) | — | Sofía at the front desk (F-199), after H10 | The catering pack (S-45, F-186), after POS research |
| Child day care | Discovery calls with three to five centres (H9) | — | The child-care pack (S-42, F-185), in 2028 after H9 | — |
| Others (insurance, events, law) | Sofía sold to insurance and events (S-47) | The law module, once the 680/705 sheet exists | Their packs (S-54 to S-56, F-181 to F-183) | Law and insurance integrations (S-57, S-58) |
...
| Use AI with the CRM | The review tray, the record summary, provenance, one model gateway | Document intake; Sofía's structured intake (F-175) | Drafting and translation, Ask BIS, the evaluation harness, the language-parity report | Memory (F-024), voice debriefs (F-026) |
| Microsoft 365 and Google, such as calendars | Google sign-in and Microsoft publisher verification (S-27, S-28) | A private calendar feed for any phone calendar (F-048 part 2); the owner's calendar, Outlook first and Google after a review of its calendar scopes (S-22); Conexiones (F-148) | Send-as-me, pickers, contacts sync (a second Google review), per-staff calendars (decision 4) | Full inbox sync only on demand (S-N10) |
| Learn from the best CRMs | HubSpot's three-column record and unified timeline; monday's recency cue, a last-contact column and a "no contact in 30 days" filter on the contact list (S-03; first release) | — | Saved views, the two-question check-in, the MCP server, importers from HubSpot and monday | — |
...
| ID | Feature | What the owner or customer gets | Effort | Horizon |
|---|---|---|---|---|
| F-008 | Language on every contact, as observed | Each contact carries the language BIS has observed, code-switching included, and it picks every message's language | S (1–1.5 beyond S-09)* | now |
...
The owner asked to use AI with the CRM. A small owner has about an hour a day for the office, so AI earns its place by summarising a record, drafting a reply in the customer's language and reading paper into fields, never by writing on its own, except the caller-confirmed acts decision 19 covers. Today AI answers calls (and can answer web chats once the agency switches the chat on for a company) and writes call summaries; its only suggestions are up to three per call, which a person accepts.
...
| F-071 | Date and stage clocks: four trigger primitives for messages and team tasks | Four fixed triggers (a date, a stage, a document expiring, a visit done) that send messages and create tasks | L (5–7 beyond S-21; 6–9 with it)* | later |
...
**Design notes.**
- Hoy is four bands, the first two above the fold on a phone; its hero is the headline number the metrics catalogue picks for the plan and pack (§6.3).
- Work goes to Pendientes, news to the timeline; there is no third inbox.
...
- The box never writes and never offers a destructive action; "ask" shows its filter chips before any number.
...
**Design notes.**
- Every new surface is drawn at 390 px first: 44 px targets, 16 px inputs, the main action within the thumb's reach.
...
**Privacy law (a reading for counsel to confirm, proposal).** Texas's Data Privacy and Security Act (TDPSA, in force since 1 July 2024) exempts businesses that are small under the U.S. Small Business Administration's definitions, which covers most of BIS's clients and probably BIS itself, except for one rule that still binds them: sensitive data, children's data included, is not sold without consent. Where a client is covered, BIS acts as its processor and owes the processor duties (a contract, help with customers' requests, deletion at the end). Law firms and insurance agencies answer to their own regimes as well, and child-care data is sensitive whether or not the TDPSA applies (study decision 6). So F-122's full "delete me" and "what do you have on me" can wait for 2029–2030, but not the path itself: today bulk delete skips any contact with a booking, deal or conversation, so until F-122 ships the agency honours a deletion request by hand, following a short runbook step this quarter, and counsel confirms which clients the TDPSA reaches.
...
| F-150 | Switch kit: move in from GoHighLevel, Jobber or HoneyBook in a day | A phone's contacts imported from a vCard file in H1 2027; later a move-in from GoHighLevel, Jobber or HoneyBook, with Spanish headers | M (4.5–6)* | next → future |
...
| F-172 | Starter packs now, plus the five blueprint fixes | Home services, insurance and events starters in the trade's own words | M (2–3)* | later |
...
| F-174 | Sofía industry modules | Sofía knows each trade's rules: no binding coverage, no legal advice, no allergy promises | M (5–6)* | now → next |
...
| F-179 | Home services pack | Licence blocks on quotes, equipment history and a heat-risk script | M (3–4 beyond S-40) | later |
...
**The forward view: the pack order (proposal, study decision 8).** Sofía sells before the packs: insurance agencies and event venues from now, law firms once the Opinion 680/705 sheet exists (decision 15). The packs then follow one order:
...
2. **Law and insurance** next, after the vault, e-signature, households, the regulated-professional baseline and identity checks. Insurance wins on the bundle, not the receptionist.
...
4. **Child care** fourth, as the Spanish front office beside the centre's own system, after money, field-level roles, broadcasts, the installable app and the integration research, and after three to five centres confirm the position (H9).
5. **Restaurant catering** fifth, after POS research, money and broadcasts, and only once a restaurant pays. Restaurants meet BIS sooner through Sofía at the front desk (F-199), if H10 holds.

**Adult day care is out, and home health with it.** HIPAA verticals (medical, dental, therapy, chiropractic, medical spa, Medicare and group health) stay behind study decision 5: F-173's vetting turns away adult day care and home health at onboarding, and holds the HIPAA verticals until decision 5 is made. Freight is a pilot after the vault; studios are a pilot in 2029–2030, later than the study's months 9–12 (decision 34).
...
| F-199 | Restaurants start with Sofía at the front desk; the catering pack comes later | Sofía answers hours, large parties and catering for restaurants, and never promises allergen safety | S–M (2–3) | later |
...
1. **Start from the day, not the database.** Every home, list and alert answers "what needs me now?" before "what happened?". *Why:* the owner has about an hour a day for the office, and DESIGN.md's own test is a business owner reading at 7 AM.
...
- **Today.** Clients have no Settings page. They can edit Branding, their booking settings on Calendar (turning the page on, hours, length, buffer, notice, horizon, alert addresses, meeting type and the follow-up email) and their forms; Voice, Automations, quiet hours, Settings, Setup and the Checklist are agency-only; the theme is saved per browser, not per person.
- **What the owner sees first.** One **Ajustes** in the sidebar footer (at the top of Más on a phone), with a search box and three scopes: **Mi cuenta** (language, display, notifications, my calendar, security); **Negocio** (Perfil y marca, Horario y cierres, Equipo, Canales, Automatizaciones, Conexiones, Plan y facturación); and **Administrado por BIS** (the phone number, texting registration, sending domain, Sofía's rules), read-only with its status and a ghost **Pedir un cambio** that lands in the agency's queue and is tracked as Recibida · En proceso · Hecha.
...
- **Built by.** F-096 (Mi cuenta in the first release; Negocio and Equipo later), F-097 (later), F-081 (later), F-084 (now), F-117, F-099, F-112 (future), and F-148 (next) on the study's Google and Microsoft track. The agency keeps its two-pane Setup and gains a read-only "Ver como Dueño" (F-098, folded into F-087).
...
| 6 | **Record views on a phone (added).** "List click opens a right-side drawer over the list." | F-001, F-005, F-107 · second sitting | On a phone the drawer is a full-height sheet with a visible close; one peek at a time, a related record replacing its content with a back link. | Proposed — needs the owner's dated decision |
...
| 9 | **The palette becomes the one box (added, additive).** The pattern "finds contacts/calls/conversations, jumps to any settings section by name, runs actions". | F-092, F-095 · with the palette v2, next | Every entry carries English and Spanish keywords; search covers every record type; "ask" answers read-only from the database with its filter shown first; it never writes and never offers a destructive action. | Proposed — needs the owner's dated decision |
...
The amendments are ruled in two sittings (decision 35): **October 2026** for the first release (rows 1, 10, 11, 18 and 20's first sections: the v2 sections for the record page, documents and provenance; the module contract; "at most one hero"; bilingual in the definition of done; the operator's default theme), and **January 2027** for next (rows 2 to 7, 9 and 13: the phone amendments, the sidebar spine, the one box and the weekly report). The rest are decided as their features start. Until an amendment is dated, new modules go into today's sidebar groups, and no feature ships nouns or patterns the contract does not yet allow.
...
| Later | Spreadsheet import with header mapping, and `.xlsx` export | S-35 | 1–2 |
...
- **Google Business Profile** needs its own API approval, which requires a verified profile active 60 days or more (BIS's own or a managed client's) and a website for that business, and has no published lead time. BIS applies this quarter (§4.2).
...
**Where email stops.** Inbound email in the first release (S-06) captures replies to mail BIS sends and anything the business forwards to a record's own address. Mail a customer writes straight to the business owner's own Gmail or Outlook does not reach the record until full inbox sync, which is direct for Outlook and, for Gmail, needs a vendor holding Google's paid security assessment; it waits for customers to ask (study §6.2).

**Google Sheets and Docs.** A customer list kept in a Google Sheet comes in today by downloading it as a CSV file, which the import wizard reads. Importing straight from a Sheet through S-25's Drive picker and S-35's header mapping, and exporting to Sheets, is a proposal for later, not costed; `.xlsx` and CSV cover the need until a client asks.

**Not planned:** Microsoft Bookings, Google and Microsoft Forms, SharePoint and Google Chat (BIS replaces or does not need them), and the dropped F-054 (a record card inside Gmail, Outlook and AI chats). Task push to Microsoft To Do and Google Tasks, and Teams notifications, stay "later" in the study.
...
| The MCP server | None | Later (S-33): reads answer at once, writes become proposals; the auth spike proves tokens are scoped to one client organisation |
...
| HubSpot and monday.com | None | Importers when a switching prospect needs one (S-36, later); a switch kit for GoHighLevel, Jobber and HoneyBook in 2029–2030 (F-150) |
...
| 5 | **Operations are blind.** Nobody is alerted when production breaks, and no restore has been tested | The operational floor ships now: heartbeats, an alert pass, a restore drill and a per-account call forward (F-119, F-120) |
...
| 8 | **Outside reviews stall.** Google's scope review, the Business Profile API, Meta's app review and the carriers' 3–7 business days | Outlook first; Google's calendar scopes submitted alone in H1 2027, a Testing-mode pilot until they pass; applications filed this quarter; texting states shown to owners in plain words |
...
| 10 | **Regulated professions carry ethics exposure.** A receptionist that gives legal advice or discusses policy terms can breach Texas rules | Guardrail modules tested in both languages (F-174), inbound-only for law firms, counsel's review of the insurance intake, and the Opinion 680/705 sheet before law sales (F-124) |
| 11 | **One person carries the product.** The pace, the agents' output and the operating knowledge rest on the owner and a very small team | The runbooks and this plan's written rules; the operational floor's alerts reach more than one person; the monthly pace check shows early when capacity drops (§4.1) |
...
- **14:** the plan shape M7a ships (how many plans, logins, storage per plan, portal placement, view-only seats, AI and MCP on every plan), and a receptionist-only plan shape for the seasonal tax offer and the auto-shop add-on, which binding constraint 3 strains (S-61 reads it as the Sofía plan sold seasonally, through F-142's levers or, if they slide, the ordinary plan for the season's months);
- **15:** sell Sofía before the packs: to insurance agencies and event venues at once, to law firms once the 680/705 sheet states the AI providers' retention terms, and to seasonal tax preparers once the security contract and U.S.-only processing attestation exist;
...
The numbering continues from 19. Each decision below gives today's position, the options, the recommendation with its reason, and what it blocks.
...
- **Options.** (a) A narrow reading. Acts the caller or visitor asks for and confirms aloud run live: book, reschedule, cancel, and leave their own name and number. Each is stamped as AI, visible on the record and undoable. Everything else, filling blank fields on an existing contact included, goes through the review tray. (b) The strict reading. Every such act becomes a proposal, bookings included. (c) F-022 as written, with blank-fills live as well.
- **Recommendation: (a).** A receptionist that cannot book while the caller is on the line is not a receptionist, so (b) would unship the product. Blank-fills are the machine's judgement about a record, and the tray already has a proposal kind for them, so (c) widens the exception for nothing. Write (a) into the rules with a date. The owner is also asked to confirm §3.2 rule 4's definition: a labelled summary or description shown only to the business's own people (F-028's descriptions, F-100's paragraph) is not an AI write. *Blocks:* F-022's item 1 (first release). The chat's updates after filing (F-023, F-036). F-024's memory writes. Machine-created holds (F-051). F-028's descriptions and F-100's paragraph, if the owner reads them as AI writes.
...
- **Recommendation: after per-staff calendars.** F-051 ships the `held` status on today's single calendar, which is all the events receptionist needs. Reversing the constraint twice is the costly path. *Blocks:* Rooms in F-051, F-183 and F-185. Round-robin in F-085. S-49.

#### 23. WhatsApp: measure now, or wait for the ledger and the provider research? (F-070; study decision 11)
...
- **Also here.** The value judge asks how F-160's generated business page sits beside the websites BIS builds and hosts for clients. Under the strict shape it is a CRM feature on every plan, and the website work stays a separate service.
...
- **Recommendation: the strict shape.** Every plan gets every CRM feature, the portal included, and per-staff calendars become an allowance. Constraint 3 reads that way. Each extra gate is a migration, a Stripe price and an enforcement point. And "everything but the receptionist, on every plan" is a sentence an owner can repeat. *Blocks:* S-13's scope (next). F-062, F-143, F-135, F-160, F-164, F-189, and the plan line of F-130.
...
- **Today.** Nothing is designated. The draft order released on 9 September 2026, for a vote on 30 September, would let a sender name one or more of three methods (a key-press opt-out, standard text keywords, or a website or number) as the exclusive means of revocation, if the method is disclosed clearly in every call or text. Its keyword method is defined by English words, so an exclusive keyword list would not cover "ALTO" or a sentence in Spanish.
...
- **Recommendation: the middle option.** Reminders and the after-job check-in are the business's own voice. Marketing is where the legal exposure lies (SB 140), so it stays with the agency. The State's position in *Ecommerce Marketers Alliance v. Texas* (W.D. Tex., dismissed in 2025) is that SB 140's registration does not reach consent-based programmes ([Consumer Financial Services Law Monitor](https://www.consumerfinancialserviceslawmonitor.com/2025/11/texas-attorney-general-confirms-opt-in-sms-is-outside-registration-under-sb-140/)), and the Secretary of State's registration FAQ now says a business texting with prior consent need not register ([K&L Gates, 14 September 2026](https://www.klgates.com/thought-leadership/Litigation-Minute-Text-Message-Marketing-in-Texas-One-Year-After-SB-140-9-14-2026)). The FAQ is not binding, an Attorney General opinion has been requested (RQ-0626-KP), and no court has yet ruled on consent-based texting under the amended chapter 302. That lowers the exposure where the ledger proves consent but does not remove it; counsel confirms. *Blocks:* the owner switches, not the features, which ship agency-configured: in F-049's text legs, F-071 and F-072, and the automations section of F-096 part 2.
...
- **Needed now:** the M2 client-access spec's "no member sync", because staff and roles (S-01) must populate users and memberships (F-117 too); raising the same spec's five-membership cap for any company that needs a fifth login, as the spec itself allows, until F-117's later part prices logins (§4.3); the same spec's agency-only settings, in part, for Mi cuenta (F-096 part 1); the booking spec's "reschedule as cancel plus rebook, and no calendar file" (F-048, a rider); the booking spec's fixed reminder timing (F-049 part 1, reminders however late they booked); the call-proposals spec's "no editing before accept" (F-019); phase 6's "fuzzy search deferred" and, narrowly, the dedupe spec's "no fuzzy name matching" (F-092 part 1, F-006); automations spec B's "no second scheduler" (F-196).
- **Needed when the feature starts:** the concierge spec's "no booking from the widget" (F-036 part 2); the work-queue spec's "no dismissals table" (F-077 part 2); the SMS spec's exclusion of inbound auto-replies (F-069); M1b's "templates as a non-goal" (F-068 part 2); engine B's single quote follow-up (F-056); the A2P and onboarding specs' "no in-app registration, no number purchase" (F-067); phase 4's saved filters (F-093); phase 5's client-facing setup view (F-099 part 2); M7a's out-of-scope annual plans and coupons (F-142, F-145); M1d's "no version history" for blueprints (F-176) and its "no hand-authored JSON" (F-171); engine B's "no text back after YES/NO" (F-049's text legs); engine B21's reply-only opt-out footer (F-065 part 2); the call-handoff spec's exclusion of warm transfer, and the shipped rule that answering-machine detection on a transfer is recorded but never acted on (F-035); the voice-core spec's deferral of recording (F-127); the booking spec's deferral of waitlists (F-050); phase 6's decision 3, cross-account search deferred (F-136); pricing logins into the plans (F-117's later part), once the cap has been raised by hand where needed; engine B's "no link" in the referral ask, which stays in force because F-018's referral link is cut, and comes back here only if H6 says yes.
...
- **Second sitting, January 2027, for next:** the phone amendments for F-107 part 2: rule 10 on a phone, blur on the bottom bar, the "+" as chrome, AI presence on a phone, record views on a phone (rows 2 to 6); the sidebar spine for F-089 (row 7); the palette as the one box (row 9); the weekly report (row 13, decision 24).
...
F-032, the last of the 26, is dropped. **The Expo on 27 September starts H1 to H4 and part of H7; the October and November calls finish them** before any events work is built.
...
| H5 | A relative often speaks or pays for the customer | "How often does a son or daughter call about a parent's account? Do you need the parent's permission on file? Does anyone pay for someone else?" | Two insurance agencies; the live HVAC client's office | F-003 parts 2 and 3; F-116's knowledge factor |
| H6 | Most new customers come by word of mouth, and the owner knows who sent them | "Of your last ten new customers, how many were referred? Do you know by whom? Do you thank them?" For trades: "Where did your last ten jobs come from: Google's guaranteed ads, Angi, Thumbtack, Yelp, or referrals?" | Every discovery call | F-018's referral link (the source question ships now in F-157), F-155 |
| H7 | Spanish-speaking customers prefer WhatsApp to texts | "Do customers ask to WhatsApp you? About what share of your messages are on WhatsApp?" Then count F-070's phase-0 clicks | Every discovery call; the live clients | F-070 part 2, F-043, F-028, F-031's WhatsApp leg |
| H8 | Owners want to change what Sofía says themselves, rather than ask BIS | "When your hours or prices change, would you rather change them on your phone, or tell us?" | The live clients; receptionist-first prospects | F-037 part 2, F-040, F-096 part 2 |
...
| H10 | Restaurants want a phone front desk for hours, large parties and catering | "How many calls a day are about hours, directions or large parties? Who answers them during the dinner rush?" | A handful of Valley restaurants | F-199, F-186, S-45 |
...
| H12 | Crews work where the phone signal drops | "Where do your technicians lose signal, and what do they do then?" | The HVAC client's technicians; other trades | F-109's field outbox |
...
| H14 | Winter Texans are a large share of some trades' customers | "What share of your customers live here only in winter?" | HVAC and pest-control clients | F-016 (dropped unless the answer is yes) |
...
| H20 | Valley businesses' Google profiles show wrong hours | No question: compare the live clients' and prospects' Google hours with what they tell us | The agency, as desk research | F-161, F-170 |
...
| H23 | Some owners run several businesses | "Do you run more than one business? Would you want them under one login?" | Every discovery call | F-086 |
...
- The October and November calls cover H6, H7, H17, H18, H19 and H23 on every call; H5 with the two insurance agencies and the HVAC client's office; H8 with the live clients and receptionist-first prospects; H9 and H18 with the centres; H10 with the restaurants; H11 with tax preparers, HVAC shops and event vendors; H12 and H14 with the HVAC client and other trades.
- H15 and H16 run as named pilots: two chambers, UTRGV and two bookkeepers for H15, three clients for H16.
...
- **Effort** is the canonical band and figure, or this plan's revision marked with an asterisk (*). "Beyond S-NN" means an increment on the study's own line.
...
| F-071 | Date and stage clocks: four trigger primitives for messages and team tasks | Messaging | L (5–7 beyond S-21; 6–9 with it)* | later | 5 | 3 · HIGH | 3 · FLAG-M | minor | Later |
...
| F-111 | Display settings that follow the person | Design | S (2) | — | 2 | 4 | 1 | minor | Folded into F-096 (display settings in Mi cuenta's one store) |
...
| F-115 | Evidence-grade records | Trust | M (2–3.5)* | now → next | 3 | 3 · med | 3 |  | Before release (tracked privately); split: history Next with S-04; hash chain dropped |
...
| F-117 | Sign-in security the owner controls | Trust | M (3.5–4.5)* | now → later | 4 | 3 · med | 2 | minor | Before release (tracked privately); split: owner controls Later |
| F-118 | See when BIS looked: access transparency and an access log | Trust | M (2.5–3.5)* | now → later | 2 · FLAG-L | 3 · med | 4 |  | Before release (tracked privately); split: client panel Later |
...
| F-172 | Starter packs now, plus the five blueprint fixes | Packs | M (2–3)* | later | 4 | 5 | 3 | **major** | Later (home services, insurance and events starters first; no restricted fields) |
...
| F-174 | Sofía industry modules | Packs | M (5–6)* | now → next | 5 | 4 · med | **5** |  | Parallel work (S-47); split: law and home-services modules Next |
...
| F-179 | Home services pack | Packs | M (3–4 beyond S-40) | later | 4 | 3 | 3 · FLAG-M |  | Later |
| F-180 | Route services module | Packs | S (0.5–1 beyond S-59)* | later | 3 | 3 | 2 · FLAG-L |  | Later |
| F-181 | Law pack | Packs | L (6–8) | later | 4 | 2 · med | 4 · FLAG-L | minor | Later (the receptionist slice sells from now through F-174) |
...
- Texas Insurance Code §4001.051: [statutes](https://tcss.legis.texas.gov/resources/in/htm/in.4001.htm)
