...
-- The header comment of fingerprint.sql explains the kinds, the allowed
-- differences, and why ACLs are compared sorted.
--
...
select kind, key, def from items order by kind, key, def;
