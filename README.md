...
four repository secrets: NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY and CLERK_SECRET_KEY
(the Clerk development instance), CI_SUPABASE_SECRET_KEY and CI_SUPABASE_DB_URL.
